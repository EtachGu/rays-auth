...
public class CustomTokenStore implements TokenStore {
    ...
    private String insertAccessTokenSql = "insert into oauth_access_token (token_id, token, authentication_id, user_name, client_id, authentication, refresh_token,created_at,updated_at,deleted_at) values (?, ?, ?, ?, ?, ?, ?,?,?,?)";;
